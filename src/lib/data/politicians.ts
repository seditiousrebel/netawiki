...
export const mockPoliticians: Politician[] = [
  {
    ...
    tags: ['education-advocate', 'environmentalist', 'urban-development'],
  ...
  },
  {
    ...
    tags: ['business-leader', 'fiscal-conservative', 'small-business'],
    isActiveInPolitics: true,
  ...
  },
  {
    ...
    tags: ['local-politics', 'community-advocate'],
    overallRating: 4.1,
    userRatingCount: 75,
    popularityScore: 90,
  },
