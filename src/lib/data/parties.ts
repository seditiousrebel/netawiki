...
const bupElectionHistory: ElectionPerformanceRecord[] = [
  { electionName: 'General Election 2024', year: '2024', seatsContested: 160, seatsWon: 72, votesPercentage: 38.2, notes: 'Increased seat share. Formed government with Progressive Coalition.' },
  ...
  { electionName: 'General Election 2019', year: '2019', seatsContested: 150, seatsWon: 65, votesPercentage: 35.5, notes: 'Formed a coalition government as senior partner.' },
...
const ragElectionHistory: ElectionPerformanceRecord[] = [
  { electionName: 'General Election 2024', year: '2024', seatsContested: 155, seatsWon: 60, votesPercentage: 32.5, notes: 'Strengthened position as main opposition party.' },
  { electionName: 'Local Elections 2022', year: '2022', seatsWon: 280, notes: 'Made significant gains in several rural councils.' },
  { electionName: 'General Election 2019', year: '2019', seatsContested: 140, seatsWon: 55, votesPercentage: 30.1, notes: 'Official opposition.' },
...
const gfpElectionHistory: ElectionPerformanceRecord[] = [
  { electionName: 'General Election 2024', year: '2024', seatsWon: 5, votesPercentage: 3.5 },
  { electionName: 'General Election 2019', year: '2019', seatsWon: 3, votesPercentage: 2.7 },
...
const ppfElectionHistory: ElectionPerformanceRecord[] = [
  { electionName: 'General Election 2024', year: '2024', seatsContested: 120, seatsWon: 25, votesPercentage: 15.5, notes: 'Significant gains, became third-largest party.' },
  { electionName: 'General Election 2019', year: '2019', seatsContested: 110, seatsWon: 20, votesPercentage: 13.5, notes: 'Consolidated support in key regions.' },
...
export const mockParties: Party[] = [
  {
    ...
    leadership: [
      ...
      { name: 'David Stalwart', role: 'Senior Advisor', politicianId: 'p3-nonexistent'}
    ],
  ...
  },
  {
    ...
    isActive: true,
    isNationalParty: true,
    controversyIds: ['c-fictional-ppf-funding-source-inquiry'],
